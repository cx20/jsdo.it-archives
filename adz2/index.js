// forked from cx20's "[WebGL] Grimoire.js + Oimo.js で消しゴムを落下させてみるテスト（その２）" http://jsdo.it/cx20/ilTV
// forked from cx20's "[WebGL] Grimoire.js + Oimo.js で消しゴムを落下させてみるテスト" http://jsdo.it/cx20/eDWo
...
*/
    ...
    for (var j = 0; j < height; j++) {
        for (var i = 0; i < 10; i++) {
            ...
            scene.addChildByName("rigid-eraser", {
                position: [x, y, z],
                rotation: [0, -i / 10 * 360 - (j % 2 == 0 ? 0 : 20), 0]
            });
        }
    }
});
