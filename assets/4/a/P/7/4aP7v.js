...
var Human = function () {
	...
	this.bones = {
		...
		lance : new Human.bone( 0,0,22    ,       150,10,10 )
	};
	...
	this.bones.lance.x = this.bones.RightLowArm.getPin().x;
	this.bones.lance.y = this.bones.RightLowArm.getPin().y;
...
Human.prototype = {
	update: function(){
	    ...
	    //this.moveArms( this.bones.RightLowArm, this.bones.lance, this.angle );
	    this.moveLance( this.bones.RightLowArm, this.bones.lance );
	...
	moveLance : function( arm, lance ) {
		lance.x = arm.getPin().x - 30;
		lance.y = arm.getPin().y;
	},
