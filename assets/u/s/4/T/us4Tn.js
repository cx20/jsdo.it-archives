...
var Human = function () {
	...
	this.bones = {
		body : new Human.bone( 0,0,0,   40,20,20 ),
		neck : new Human.bone( 0,0,0,   25,10,10 ),
		head : new Human.bone( 0,0,0    ),

		LeftUpLeg : new Human.bone(   200,200,-10,  20,15,15 ),
		LeftLowLeg : new Human.bone(  0,0,-10,      30,10,10 ), 
		RightUpLeg : new Human.bone(  200,200,10,   20,15,15 ),
		RightLowLeg : new Human.bone( 0,0,10,       30,10,10 ),
		
		LeftUpArm : new Human.bone(   0,0,-22,      20,10,10 ),
		LeftLowArm : new Human.bone(  0,0,-22,      30,7,7   ),
		RightUpArm : new Human.bone(  0,0,22,       20,10,10 ),
		RightLowArm : new Human.bone( 0,0,22,       30,7,7   )
	};
