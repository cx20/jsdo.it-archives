...
function load() {
  ...
  //          |                     |           +------------------ accessors[2] : NORMAL     (36 bytes =  4 bytes * 3 * 3)
  //          |                     |           |        
  // +----------------+      +------------+------------+
  ...
  // +-------------------------------------------------+
  //
  // |[0][1]....[4][5]|[6][7]|[8][9]...........[70][71]|
  // |<--- 6 bytes -->|2bytes|<------ 72 bytes ------->|
  // |<------------------ 80 bytes ------------------->|
...
function render() {
  ...
  for ( i = 0; i < gltf.scenes[0].nodes.length; i++ ) {
    ...
    vec3.set(translation, nodeTranslation[0] - 1, nodeTranslation[1] - 0.5, nodeTranslation[2] - 2 );
