...
function populate(n) {
    ...
    var max = 1000; // dataSet.length; // document.getElementById("MaxNumber").value;
    ...
    for (var i = 0; i < y2; i++) {
        ...
        for (var j = 0; j < x2; j++) {
            ...
            var ground2 = new OIMO.Body({size:[20, 20, 20], pos:[x*5, y*5, z*5], world:world, config:config});
            addStaticBox([20, 20, 20], [x*5, y*5, z*5], [0,0,0]);
        }
    }


    var ground3 = new OIMO.Body({size:[400, 10, 390], pos:[400,300,0], rot:[0,0,20], world:world, config:config});
    addStaticBox([400, 10, 390], [400,300,0], [0,0,20]);
