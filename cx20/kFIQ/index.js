...
function initBuffers() {
    ...
    for ( var i = dataSet.length - 1; i > 0; i-- ) {
        ...
        if ( dataSet[i] != "無" ) {
            ...
            data = data.concat( [x + 0.0,          y + DOT_SIZE*0.8, 0.0          ] ); // v1
            data = data.concat( [x + DOT_SIZE*0.8, y + DOT_SIZE*0.8, 0.0          ] ); // v2
            data = data.concat( [x + DOT_SIZE*0.8, y + 0.0,          0.0          ] ); // v3
            
            data = data.concat( [x + 0.0,          y + 0.0,          -DOT_SIZE*0.8] ); // v4
            data = data.concat( [x + 0.0,          y + DOT_SIZE*0.8, -DOT_SIZE*0.8] ); // v5
            data = data.concat( [x + DOT_SIZE*0.8, y + DOT_SIZE*0.8, -DOT_SIZE*0.8] ); // v6
            data = data.concat( [x + DOT_SIZE*0.8, y + 0.0,          -DOT_SIZE*0.8] ); // v7
