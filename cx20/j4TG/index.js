...
function drawMario() {
    ...
    for ( i = 0; i < dataSet.length; i++ ) {
        ...
        drawDot( x, y, colorR, colorG, colorB );
    }
    pos++;
}

function drawDot( x, y, colorR, colorG, colorB ) {
    drawArc( x+7*SCALE*0, y, 3*SCALE, colorR );
    drawArc( x+7*SCALE*1, y, 3*SCALE, colorG );
    drawArc( x+7*SCALE*2, y, 3*SCALE, colorB );

    drawArc( -2+x+7*SCALE*0, y+5*SCALE, 3*SCALE, colorG );
    drawArc( -2+x+7*SCALE*1, y+5*SCALE, 3*SCALE, colorB );
    drawArc( -2+x+7*SCALE*2, y+5*SCALE, 3*SCALE, colorR );

    drawArc( x+7*SCALE*0, y+10*SCALE, 3*SCALE, colorR );
    drawArc( x+7*SCALE*1, y+10*SCALE, 3*SCALE, colorG );
    drawArc( x+7*SCALE*2, y+10*SCALE, 3*SCALE, colorB );

    drawArc( -2+x+7*SCALE*0, y+15*SCALE, 3*SCALE, colorG );
    drawArc( -2+x+7*SCALE*1, y+15*SCALE, 3*SCALE, colorB );
    drawArc( -2+x+7*SCALE*2, y+15*SCALE, 3*SCALE, colorR );
}
