// forked from cx20's "[WebGL] Cesium.js で glTF 2.0形式のデータを表示してみるテスト（その２１）（調整中）" http://jsdo.it/cx20/Mcta
// forked from cx20's "[WebGL] Cesium.js で glTF 2.0形式のデータを表示してみるテスト（その２０）（調整中）" http://jsdo.it/cx20/q8ln
// forked from cx20's "[WebGL] Cesium.js で glTF 2.0形式のデータを表示してみるテスト（その１９）（調整中）" http://jsdo.it/cx20/Sdyg
...
//createModel('https://cdn.jsdelivr.net/gh/mrdoob/three.js@r97/examples/models/gltf/BotSkinned/glTF-MaterialsUnlit/Bot_Skinned.gltf', 10000);
//createModel('https://cdn.jsdelivr.net/gh/cx20/gltf-test@7af4f399/tutorialModels/SpecGlossVsMetalRough/glTF/SpecGlossVsMetalRough.gltf', 10000);
//createModel('https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@33ab7250/models/gltf/2.0/Itokawa/glTF-Draco/Itokawa.glb', 10000);
//createModel('https://cdn.jsdelivr.net/gh/BabylonJS/Exporters@9bc140006be149687be045f60b4a25cdb45ce4fc/Maya/Samples/glTF 2.0/T-Rex/trex_running.gltf', 10000);
createModel('https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@ef789b017e86ed960bd38df4617fadbbfbd245ec/models/gltf/2.0/Kaendoki/glTF-Binary/Kaendoki.glb', 10000);
