// forked from cx20's "箱根山周辺の3Dデータを表示してみる（その５）" http://jsdo.it/cx20/1FkX
...
var MAP = "../../assets/i/D/M/u/iDMuq.jpg";  // 空撮写真＋駅伝コース追加
var ROTATE = true;
...
img.onload = function() {
    ...
    var mapSelector = gui.add(window, 'MAP', {
        "通常地図": "../../assets/2/Q/J/O/2QJOU.jpg", // 通常地図＋駅伝コース追加
        "空撮写真": "../../assets/i/D/M/u/iDMuq.jpg"  // 空撮写真＋駅伝コース追加
    });
