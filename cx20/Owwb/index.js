// forked from cx20's "[WebGL] Babylon.js + SolidParticleSystem を試してみるテスト（その２改）" http://jsdo.it/cx20/INE1
// forked from cx20's "[WebGL] Babylon.js + SolidParticleSystem を試してみるテスト（その２）" http://jsdo.it/cx20/Clm4
...
var createScene = function() {
    ...
    camera.setPosition(new BABYLON.Vector3(0, 150, -300));
    ...
    var url = "../../assets/k/q/1/k/kq1ka.jpg";  // Suzanne.jpg
    var mat = new BABYLON.StandardMaterial("mat1", scene);
    mat.backFaceCulling = false;
    var texture = new BABYLON.Texture(url, scene);
    mat.diffuseTexture = texture;
    mat.opacityTexture = texture;
    mat.specular = new BABYLON.Color3(0, 0, 0);
    ...
    //BABYLON.SceneLoader.ImportMesh("", "/assets/E/c/r/y/", "Ecryr", scene, function(meshes) { // rabbit.babylon
    BABYLON.SceneLoader.ImportMesh("", "../../assets/4/D/o/o/", "4DooI.babylon", scene, function(meshes) { // monkey.babylon
