...
function createObjects() {
    ...
    texture = textureLoader.load("../../assets/6/i/o/K/6ioKy.png"); // akaoni_tate.png

    // Stones
    var stoneMass = 120 * 2;
    var stoneHalfExtents = new THREE.Vector3( 1*3, 2*2, 0.15*3 );
    quat.set( 0, 0, 0, 1 );
    ...
    pos.set( 0, 0, 0 );
    createObject( stoneMass, stoneHalfExtents, pos, quat, material );
}
