// forked from cx20's "Three.js + Oimo.js でフロッピーを落下させてみるテスト（その２）" http://jsdo.it/cx20/WilT
// forked from cx20's "Three.js + Oimo.js でフロッピーを落下させてみるテスト" http://jsdo.it/cx20/Uf66
// forked from cx20's "Three.js + Oimo.js でノートを落下させてみるテスト" http://jsdo.it/cx20/tXyl
...
function init() {
    ...
    var materialsA = [
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('./A1.png')}), // A1.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('./A2.png')}), // A2.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('./A3.png')}), // A3.png (front)
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('./A4.png')}), // A4.png (back)
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('./A5.png')}), // A5.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('./A6.png')})  // A6.png
    ];

    var materialsB = [
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('./B1.png')}), // B1.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('./B2.png')}), // B2.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('./B3.png')}), // B3.png (front)
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('./B4.png')}), // B4.png (back)
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('./B5.png')}), // B5.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('./B6.png')}), // B6.png
    ];
    
    matBox = new THREE.MeshLambertMaterial( {  map: basicTexture(0), name:'box' } );
    matFloppy[0] = new THREE.MeshFaceMaterial( materialsA );
    matFloppy[1] = new THREE.MeshFaceMaterial( materialsB );
...
function populate(n) {
    ...
    while (i--){
        ...
        if(t===2){
            ...
            var idx = Math.floor(Math.random() * matFloppy.length );
            meshs[i] = new THREE.Mesh( buffgeoMono, matFloppy[idx] );
