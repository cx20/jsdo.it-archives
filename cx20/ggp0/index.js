...
function convJapaneseToSoramimiEnglish() {
    ...
    var strJapanese = document.getElementById("txtJapanese").value;
    soramimi.ConvertJapaneseToEnglish(strJapanese);
    document.getElementById("txtEnglish").value = soramimi.English;
}
