// forked from cx20's "GLBoost + Oimo.js でモデルを落下させてみるテスト（改2）" http://jsdo.it/cx20/Kx37
// forked from cx20's "GLBoost + Oimo.js でモデルを落下させてみるテスト（改）" http://jsdo.it/cx20/em6h
// forked from cx20's "GLBoost + Oimo.js でモデルを落下させてみるテスト" http://jsdo.it/cx20/wnJX
...
*/
    ...
    promise.then(function(mesh) {
        ...
        while (i--){
            ...
            //var geometry = new GLBoost.Sphere(w*0.5, 12, 12);
