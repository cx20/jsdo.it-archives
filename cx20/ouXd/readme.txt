[WebGL] Processing.js を試してみるテスト（JavaScript編）（その４）

＜対応した点＞
・Processing.js を JavaScript のライブラリとして用いるよう対応。
・テクスチャ画像を立方体に貼り付けるよう対応

＜参考＞
■ [WebGL] Processing.js を試してみるテスト（組み込み言語編）（その４）
http://jsdo.it/cx20/eHwD
