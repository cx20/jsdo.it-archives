// forked from cx20's "[WebGL] Hilo3d で glTF 2.0 モデルを表示してみるテスト（その２１）（調整中）" http://jsdo.it/cx20/8UrE
// forked from cx20's "[WebGL] Hilo3d で glTF 2.0 モデルを表示してみるテスト（その２０）（調整中）" http://jsdo.it/cx20/wecq
// forked from cx20's "[WebGL] Hilo3d で glTF 2.0 モデルを表示してみるテスト（その１９）（調整中）" http://jsdo.it/cx20/wsbY
// forked from cx20's "[WebGL] Hilo3d で glTF 2.0 モデルを表示してみるテスト（その１８）（調整中）" http://jsdo.it/cx20/oQkl
// forked from cx20's "[WebGL] Hilo3d で glTF 2.0 モデルを表示してみるテスト（その１７）（調整中）" http://jsdo.it/cx20/m6tR
// forked from cx20's "[WebGL] Hilo3d で glTF 2.0 モデルを表示してみるテスト（その１６）（調整中）" http://jsdo.it/cx20/4MPF
...
//var url = "https://cdn.jsdelivr.net/gh/mrdoob/three.js@dev/examples/models/gltf/LittlestTokyo.glb";
//var url = "https://ft-lab.github.io/gltf/yunomi/Yunomi_normal_20.glb";
//var url = "https://cdn.jsdelivr.net/gh/bghgary/glTF-Asset-Generator@a66119b3/Output/Material/Material_01.gltf";
//var url = "https://cdn.jsdelivr.net/gh/bghgary/glTF-Asset-Generator@a66119b3/Output/Material/Material_04.gltf";
//var url = "https://cdn.jsdelivr.net/gh/bghgary/glTF-Asset-Generator@a66119b3/Output/Material/Material_07.gltf";
//var url = "https://cdn.jsdelivr.net/gh/mrdoob/three.js@r97/examples/models/gltf/BotSkinned/glTF-MaterialsUnlit/Bot_Skinned.gltf";
//var url = "https://cdn.jsdelivr.net/gh/cx20/gltf-test@7af4f399/tutorialModels/SpecGlossVsMetalRough/glTF/SpecGlossVsMetalRough.gltf";
//var url = "https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@33ab7250/models/gltf/2.0/Itokawa/glTF-Draco/Itokawa.glb";
...
var loadQueue = new Hilo3d.LoadQueue([{
    type: 'CubeTexture',
    images: [
        'https://cdn.jsdelivr.net/gh/cx20/gltf-test@c479d543/textures/cube/skybox/diffuse/bakedDiffuse_01.jpg',
        'https://cdn.jsdelivr.net/gh/cx20/gltf-test@c479d543/textures/cube/skybox/diffuse/bakedDiffuse_02.jpg',
        'https://cdn.jsdelivr.net/gh/cx20/gltf-test@c479d543/textures/cube/skybox/diffuse/bakedDiffuse_03.jpg',
        'https://cdn.jsdelivr.net/gh/cx20/gltf-test@c479d543/textures/cube/skybox/diffuse/bakedDiffuse_04.jpg',
        'https://cdn.jsdelivr.net/gh/cx20/gltf-test@c479d543/textures/cube/skybox/diffuse/bakedDiffuse_05.jpg',
        'https://cdn.jsdelivr.net/gh/cx20/gltf-test@c479d543/textures/cube/skybox/diffuse/bakedDiffuse_06.jpg'
    ]
}, {
    type: 'CubeTexture',
    right: 'https://cdn.jsdelivr.net/gh/cx20/gltf-test@c479d543/textures/cube/skybox/px.jpg',
    left: 'https://cdn.jsdelivr.net/gh/cx20/gltf-test@c479d543/textures/cube/skybox/nx.jpg',
    top: 'https://cdn.jsdelivr.net/gh/cx20/gltf-test@c479d543/textures/cube/skybox/py.jpg',
    bottom: 'https://cdn.jsdelivr.net/gh/cx20/gltf-test@c479d543/textures/cube/skybox/ny.jpg',
    front: 'https://cdn.jsdelivr.net/gh/cx20/gltf-test@c479d543/textures/cube/skybox/pz.jpg',
    back: 'https://cdn.jsdelivr.net/gh/cx20/gltf-test@c479d543/textures/cube/skybox/nz.jpg',
},{
    src: 'https://cdn.jsdelivr.net/gh/cx20/gltf-test@c479d543/textures/brdfLUT.png',
    type:'Texture'
},{
    src:url
}]).on('load', function(e){
