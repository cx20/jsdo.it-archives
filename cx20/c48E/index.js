...
var MAP = "../../assets/s/9/Z/2/s9Z2u.jpg";
var SMOKE = false;
var ROTATE = true;
var WIREFRAME = false;
...
function initParticles() {
    ...
    emitter = new SPE.Emitter({
        ...
        position: {
            value: new THREE.Vector3(12, 13, -9),
...
img.onload = function() {
    ...
    var mapSelector = gui.add(window, 'MAP', {
        "通常地図": "../../assets/u/C/D/P/uCDPS.jpg",
        "空撮写真": "../../assets/g/K/n/a/gKnaC.jpg",
...
//img.src = "/assets/E/R/Q/2/ERQ2H.png"; // heightMap.png
img.src = "../../assets/g/B/6/9/gB69w.png";
