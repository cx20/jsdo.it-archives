// forked from cx20's "[簡易版] GLSL でパーティクルの形を変えてみるテスト（その３）" http://jsdo.it/cx20/l8dH
// forked from cx20's "[簡易版] GLSL でパーティクルの形を変えてみるテスト（その２）" http://jsdo.it/cx20/kx1F
// forked from cx20's "[簡易版] GLSL でパーティクルの形を変えてみるテスト" http://jsdo.it/cx20/2D2z
// forked from cx20's "[簡易版] WebGL で100万パーティクルを表示してみるテスト（改）" http://jsdo.it/cx20/iIUA
// forked from cx20's "[簡易版] WebGL で100万パーティクルを表示してみるテスト" http://jsdo.it/cx20/UlyJ
// forked from cx20's "[簡易版] WebGL で小惑星をプロットしてみるテスト（その３）" http://jsdo.it/cx20/1Z18
...
function initShaders() {
    ...
    uLoc[2] = gl.getUniformLocation(p, 'resolution');
...
function render() {
    ...
    gl.uniform2f(uLoc[2], c.width, c.height);
