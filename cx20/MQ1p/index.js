// forked from cx20's "Babylon.js glTF Serializer を使ってみるテスト（その２）" http://jsdo.it/cx20/KZmE
// forked from cx20's "Babylon.js glTF Serializer を使ってみるテスト（調整中）" http://jsdo.it/cx20/0ZaI
...
function createScene(engine) {
    ...
    var colorArray = ["赤","青","黄","茶","肌"];
    let mergedBoxies = {};
    for (let i = 0; i < colorArray.length; i++ ) {
        let c = colorArray[i];
        mergedBoxies[c] = BABYLON.Mesh.MergeMeshes(boxies[c]);
        ...
        mergedBoxies[c].material = material;
        mergedBoxies[c].parent = sphere;
    }
