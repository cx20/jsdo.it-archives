...
function draw() {
    ...
    for ( var i = 0; i < 256; i++ ) {
        ...
        if ( dataSet[i] != "無" ) {
            ...
            position = position.concat( [x + 0.0,      y + 0.0,      0.0] );
            position = position.concat( [x + 1/16*0.8, y + 0.0,      0.0] );
            position = position.concat( [x + 1/16*0.8, y + 1/16*0.8, 0.0] );
            position = position.concat( [x + 0.0,      y + 1/16*0.8, 0.0] );
