// forked from cx20's "[WebGL] three.js を試してみるテスト（InstancedBuffer編）（その２）" http://jsdo.it/cx20/SdG0
// forked from cx20's "[WebGL] three.js を試してみるテスト（InstancedBuffer編）" http://jsdo.it/cx20/0Gs9
...
function init() {
    ...
    geometry.addAttribute( 'instanceID', instanceIDs ); // per mesh instance
    ...
    // material
    var texture1 = THREE.ImageUtils.loadTexture( '../../assets/A/k/w/j/AkwjW.jpg' ); // frog.jpg
    var texture2 = THREE.ImageUtils.loadTexture( '../../assets/s/f/u/I/sfuI6.jpg' ); // wall.jpg
