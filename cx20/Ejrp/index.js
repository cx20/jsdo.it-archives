...
var ballTexture = loader.load("../../assets/u/w/x/F/uwxFy.jpg"); // PokeBall_512x256.jpg
var ballBumpTexture = loader.load("../../assets/c/P/m/r/cPmrG.jpg"); // PokeBallBump_512x256.jpg
var ballMaterial = new THREE.MeshPhongMaterial({
    //color: 0xedca8e,
    map: ballTexture,
    bumpMap: ballBumpTexture
});
...
function createObjects() {
    ...
    var texture = THREE.ImageUtils.loadTexture( '../../assets/m/A/i/u/mAiuD.png' );  // akaoni.png
    ...
    var obstacle = createParalellepiped(6, 1, 4, 0, pos, quat, material);
