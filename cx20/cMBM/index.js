...
const createScene = function () {
    ...
    const ground = BABYLON.Mesh.CreateGroundFromHeightMap("ground", "../../assets/b/c/p/q/bcpqo.png", 100, 100, 100, 0, 20, scene, false);
    const groundMaterial = new BABYLON.StandardMaterial("ground", scene);
    //groundMaterial.diffuseTexture = new BABYLON.Texture("ground.jpg", scene);
    groundMaterial.diffuseTexture = new BABYLON.Texture("../../assets/7/y/G/d/7yGd4.jpg", scene);
