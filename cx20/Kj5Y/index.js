...
class App {
  constructor() {
    ...
    const mat = engine.createMaterial('https://cx20.github.io/webgl-test/examples/filament/triangle/triangle.filamat');
...
Filament.init(['https://cx20.github.io/webgl-test/examples/filament/triangle/triangle.filamat'], () => {
  window.app = new App()
});