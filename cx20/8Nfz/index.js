...
*/
    ...
    this.AppendDic("きゃ = ⠈⠡; きゅ = ⠈⠩; きょ = ⠈⠪");
    this.AppendDic("しゃ = ⠈⠱; しゅ = ⠈⠹; しぇ = ⠈⠻; しょ = ⠈⠺");
    this.AppendDic("ちゃ = ⠈⠕; ちゅ = ⠈⠝; ちぇ = ⠈⠟; ちょ = ⠈⠞");
    this.AppendDic("にゃ = ⠈⠅; にゅ = ⠈⠍; にょ = ⠈⠎");
    this.AppendDic("ひゃ = ⠈⠥; ひゅ = ⠈⠭; ひょ = ⠈⠮");
    this.AppendDic("みゃ = ⠈⠵; みゅ = ⠈⠽; みょ = ⠈⠾");
    this.AppendDic("いぇ = ⠈⠋; りゃ = ⠈⠑; りゅ = ⠈⠙; りょ = ⠈⠚");
    this.AppendDic("うぁ = ⠢⠁; うぃ = ⠢⠃; うぇ = ⠢⠋; うぉ = ⠢⠊");
    this.AppendDic("くぁ = ⠢⠡; くぃ = ⠢⠣; くぇ = ⠢⠫; くぉ = ⠢⠪");
    this.AppendDic("すぃ = ⠈⠳");
    this.AppendDic("てぃ = ⠈⠗; てゅ = ⠨⠝");
    this.AppendDic("つぁ = ⠢⠕; つぃ = ⠢⠗; つぇ = ⠢⠟; つぉ = ⠢⠞; とぅ = ⠢⠝");
    this.AppendDic("ふぁ = ⠢⠥; ふぃ = ⠢⠧; ふぇ = ⠢⠯; ふぉ = ⠢⠮");
    this.AppendDic("ふゅ = ⠨⠬; ふょ = ⠨⠜");
    ...
    this.AppendDic("ゔ = ⠐⠉");
    this.AppendDic("ずぃ = ⠘⠳");
    this.AppendDic("でぃ = ⠘⠗; どぅ = ⠲⠝");
    this.AppendDic("ぎゃ = ⠘⠡; ぎゅ = ⠘⠩; ぎょ = ⠘⠪");
    this.AppendDic("じゃ = ⠘⠱; じゅ = ⠘⠹; じぇ = ⠘⠻; じょ = ⠘⠺");
    this.AppendDic("ぢゃ = ⠘⠕; ぢゅ = ⠘⠝; ぢょ = ⠘⠞");
    this.AppendDic("でゅ = ⠸⠝");
    this.AppendDic("びゃ = ⠘⠥; びゅ = ⠘⠭; びょ = ⠘⠮");
    this.AppendDic("ぴゃ = ⠨⠥; ぴゅ = ⠨⠭; ぴょ = ⠨⠮");
    this.AppendDic("ゔぁ = ⠲⠥; ゔぃ = ⠲⠧; ゔぇ = ⠲⠯; ゔぉ = ⠲⠮");
    this.AppendDic("ゔゅ = ⠸⠬; ゔょ = ⠸⠜");
    this.AppendDic("ぐぁ = ⠲⠡; ぐぃ = ⠲⠣; ぐぇ = ⠲⠫; ぐぉ = ⠲⠪");
    this.AppendDic("あー = ⠁⠒; いー = ⠃⠒; うー = ⠉⠒; えー = ⠋⠒; おー = ⠊⠒");
    this.AppendDic("がー = ⠐⠡⠒; きゃー = ⠈⠡⠒");
    this.AppendDic("あっ = ⠁⠂; いっ = ⠃⠂; うっ = ⠉⠂; えっ = ⠋⠂; おっ = ⠊⠂");
    this.AppendDic("ぽっ = ⠐⠮⠂");
    this.AppendDic("ふぉっ = ⠢⠮⠂");
    // 記号類
    this.AppendDic("っ=⠂; ー=⠒; 、=⠰; 。=⠲;？=⠢; ！=⠖;・=⠐"); 
