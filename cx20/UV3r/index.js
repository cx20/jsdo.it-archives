// forked from cx20's "Three.js + Oimo.js でスナック菓子を落下させてみるテスト（改）" http://jsdo.it/cx20/EyiF
// forked from cx20's "Three.js + Oimo.js でスナック菓子を落下させてみるテスト" http://jsdo.it/cx20/oslD
...
function createMesh() {
    ...
    var coin_sides_texture           = THREE.ImageUtils.loadTexture("../../assets/k/p/M/F/kpMFW.png"); // side.png
    var coin_sides_texture_bump      = THREE.ImageUtils.loadTexture("../../assets/q/d/w/c/qdwce.png"); // side_bump.png
    var coin_cap_texture_top         = THREE.ImageUtils.loadTexture("../../assets/k/A/1/9/kA19B.png"); // top.png
    var coin_cap_texture_top_bump    = THREE.ImageUtils.loadTexture("../../assets/q/7/G/t/q7GtN.png"); // top_bump.png
    var coin_cap_texture_bottom      = THREE.ImageUtils.loadTexture("../../assets/8/X/e/w/8Xewj.png"); // bottom.png
    var coin_cap_texture_bottom_bump = THREE.ImageUtils.loadTexture("../../assets/4/D/i/4/4Di4G.png"); // bottom_bump.png
