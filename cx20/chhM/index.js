// forked from cx20's "[WebGL] Grimoire.js で太陽を表示させてみるテスト（改）" http://jsdo.it/cx20/MfdW
// forked from cx20's "[WebGL] Grimoire.js で太陽を表示させてみるテスト（調整中）" http://jsdo.it/cx20/qaQz
