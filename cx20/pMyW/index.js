// forked from cx20's "Three.js + Oimo.js で坂道にビリヤードの玉を転がしてみるテスト" http://jsdo.it/cx20/o5OP
// forked from cx20's "Three.js + Oimo.js で坂道に地球を転がしてみるテスト" http://jsdo.it/cx20/w0BH
...
function updateOimoPhysics() {
    ...
    while (i--){
        ...
        if(!body.sleeping){
            ...
            for ( var pos = 0 ; pos < dataSet.length; pos++ ) {
	            if(mesh.material.name === 'ssph' + pos) mesh.material = matSpheres[pos]; 
            }
            ...
            for ( var pos = 0 ; pos < dataSet.length; pos++ ) {
                if(mesh.material.name === 'sph' + pos) mesh.material = matSphereSleep[i];
            }
        }
    }
