// forked from cx20's "[WebGL] Grimoire.js + glTF ファイルを試してみるテスト（その１４）（調整中）" http://jsdo.it/cx20/QWWf
// forked from cx20's "[WebGL] Grimoire.js + glTF ファイルを試してみるテスト（その１３）（調整中）" http://jsdo.it/cx20/2ZuW
// forked from cx20's "[WebGL] Grimoire.js + glTF ファイルを試してみるテスト（その１２）（調整中）" http://jsdo.it/cx20/qtA2
// forked from cx20's "[WebGL] Grimoire.js + glTF ファイルを試してみるテスト（その１１）" http://jsdo.it/cx20/GVDM
// forked from cx20's "[WebGL] Grimoire.js + glTF ファイルを試してみるテスト（その１０）（調整中）" http://jsdo.it/cx20/Ws6a
...
// モデル読み込まれた後に移動させるよう１秒後に位置移動させる（暫定対応）
setTimeout(changePosition, 1000);

function changePosition() {
  var $$ = gr('#canvas');
  $$('object.technic_driver_assy-node').setAttribute('position', "0, 0, 100");
}
