// forked from cx20's "[WebVR] three.js で WebVR を試してみるテスト（その９）（調整中）" http://jsdo.it/cx20/61Ar
// forked from cx20's "[WebVR] three.js で WebVR を試してみるテスト（その８）（調整中）" http://jsdo.it/cx20/KqBG
...
function init() {
    ...
    let url = "https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-WebGL-PBR@88eda8c5/models/FarmLandDiorama/glTF/FarmLandDiorama.gltf";
