...
function draw() {
    ...
    var B = 8.0;
    for ( var i = 0; i <= MAX; i++ ) {
        var x = 0.5 * Math.sin(2 * Math.PI * i / MAX * A) * Math.cos(2 * Math.PI * i / MAX * B);
        var y = 0.5 * Math.sin(2 * Math.PI * i / MAX * A) * Math.sin(2 * Math.PI * i / MAX * B);
        var z = 0.5 * Math.cos(2 * Math.PI * i / MAX * A);
