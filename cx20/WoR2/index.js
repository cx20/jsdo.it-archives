// forked from cx20's "3D描画入門（その４.Gouraud Shading）" http://jsdo.it/cx20/e5rO
// forked from cx20's "3D描画入門（その３.Flat Shading）" http://jsdo.it/cx20/Q2cR
// forked from cx20's "3D描画入門（その２.Rasterization）" http://jsdo.it/cx20/ADDX
// forked from cx20's "3D描画入門（その１.Wireframe）" http://jsdo.it/cx20/2S44
// forked from cx20's "2016年の干支といえば" http://jsdo.it/cx20/y6iK

// forked from http://david.blob.core.windows.net/html5/SoftEngineProgression/textured/index.html
...
function init() {
    ...
    //device.LoadJSONFileAsync("/assets/O/5/l/r/O5lrg", loadJSONCompleted);
    device.LoadJSONFileAsync("https://david.blob.core.windows.net/html5/SoftEngineProgression/textured/monkey.babylon", loadJSONCompleted);
}
