// forked from cx20's "[WebGL] ClayGL で glTF 2.0 モデルを表示してみるテスト（その２１）（調整中）" http://jsdo.it/cx20/umMC
// forked from cx20's "[WebGL] ClayGL で glTF 2.0 モデルを表示してみるテスト（その２０）（調整中）" http://jsdo.it/cx20/gc8z
// forked from cx20's "[WebGL] ClayGL で glTF 2.0 モデルを表示してみるテスト（その１９）（調整中）" http://jsdo.it/cx20/6TdL
...
var app = clay.application.create('#main', {
    ...
    init: function (app) {
        ...
        return app.loadModel(url).then((function (result) {
            ...
            this._gltfModel.position.set(0, -2, 0);
