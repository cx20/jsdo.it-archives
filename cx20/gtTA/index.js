// forked from cx20's "[WebGL] three.js で glTF 2.0形式のデータを表示してみるテスト（その２１）（調整中）" http://jsdo.it/cx20/aq1x
...
function init() {
	...
	const dracoLoader = new DRACOLoader().setDecoderPath( 'https://rawcdn.githack.com/mrdoob/three.js/r155/examples/jsm/libs/draco/gltf/' );
