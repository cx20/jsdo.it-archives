...
function init() {
    ...
    var materialsBlack = [
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/w/Y/k/m/wYkmV.png')}), // 1.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/w/Y/k/m/wYkmV.png')}), // 2.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/0/m/M/H/0mMHt.png')}), // 3.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/y/l/l/6/yll6A.png')}), // 4.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/w/Y/k/m/wYkmV.png')}), // 5.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/w/Y/k/m/wYkmV.png')})  // 6.png
    ];

    var materialsYellow = [
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/i/6/e/n/i6en0.png')}), // yellow.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/i/6/e/n/i6en0.png')}), // yellow.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/s/4/v/F/s4vFR.png')}), // yellow_fd_front.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/A/d/x/l/AdxlT.png')}), // yellow_fd_back.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/i/6/e/n/i6en0.png')}), // yellow.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/i/6/e/n/i6en0.png')}), // yellow.png
    ];
    
    matBox = new THREE.MeshLambertMaterial( {  map: basicTexture(0), name:'box' } );
    matFloppy[0] = new THREE.MeshFaceMaterial( materialsBlack );
    matFloppy[1] = new THREE.MeshFaceMaterial( materialsYellow );
