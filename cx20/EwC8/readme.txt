[WebGL] xml3d.js を試してみるテスト（その３）

xml3d.js は XML の 3D 規格である XML3D の WebGL 実装のようです。

＜対応した点＞
・xml3d.js で立方体に色を付けるよう対応。
...
■ xml3d/xml3d-examples
https://github.com/xml3d/xml3d-examples
