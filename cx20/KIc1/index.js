// forked from cx20's "[WebGL] Babylon.js で火星を回してみるテスト" http://jsdo.it/cx20/qB1p
...
var createScene = function(){
    ...
    material1.diffuseTexture  = new BABYLON.Texture("../../assets/A/c/s/z/Acszz.jpg", scene); // mars_ocean2_1024.jpg
    material1.normalTexture   = new BABYLON.Texture("../../assets/q/W/O/6/qWO6j.jpg", scene); // mars_normal_1024.jpg
    material1.specularTexture = new BABYLON.Texture("../../assets/o/0/k/o/o0koZ.jpg", scene); // mars_specular2_1024.jpg
