// forked from chandlerprall's "Physijs Rigid body example" http://chandlerprall.github.io/Physijs/examples/body.html
...
initScene = function() {
    ...
    ground_material = Physijs.createMaterial(
        //new THREE.MeshLambertMaterial({ map: THREE.ImageUtils.loadTexture( '/assets/z/h/b/T/zhbTu.jpg' ) }), // rocks.jpg
        new THREE.MeshLambertMaterial({ map: THREE.ImageUtils.loadTexture( '../../assets/z/h/b/T/zhbTu.jpg' ) }), // rocks.jpg
        .8, // high friction
        .4 // low restitution
    );
    ...
    box_material = Physijs.createMaterial(
        //new THREE.MeshLambertMaterial({ map: THREE.ImageUtils.loadTexture( '/assets/a/F/g/Z/aFgZ2.jpg' ) }), // plywood.jpg
        new THREE.MeshLambertMaterial({ map: THREE.ImageUtils.loadTexture( '../../assets/A/f/g/Z/AfgZ2.jpg' ) }), // plywood.jpg
        .4, // low friction
        .6 // high restitution
    );
