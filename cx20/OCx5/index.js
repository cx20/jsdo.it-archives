// forked from cx20's "[WebGL] Grimoire.js + glTF + パレットテスト（その３）" http://jsdo.it/cx20/MkeS
// forked from cx20's "[WebGL] Grimoire.js + glTF + パレットテスト（その２）" http://jsdo.it/cx20/gsEW
// forked from cx20's "[WebGL] Grimoire.js + glTF + パレットテスト（その１）" http://jsdo.it/cx20/g0Xf
// forked from cx20's "[WebGL] Grimoire.js + glTF ファイルを試してみるテスト（その８）（改）（調整中）" http://jsdo.it/cx20/gANK
