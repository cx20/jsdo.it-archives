// forked from cx20's "プログラマブルシェーダーでドット絵の色を変更するテスト" http://jsdo.it/cx20/iZRs
...
var dataSet2 = [
    "茶","肌","肌","肌","肌","肌","肌","肌","肌","無","茶","肌","肌","肌","肌","茶",
    "肌","茶","茶","茶","茶","茶","茶","茶","茶","無","肌","茶","茶","茶","茶","無",
    "肌","茶","茶","茶","茶","茶","茶","茶","茶","無","肌","茶","茶","茶","茶","無",
    "肌","茶","茶","茶","茶","茶","茶","茶","茶","無","肌","茶","茶","茶","茶","無",
    "肌","茶","茶","茶","茶","茶","茶","茶","茶","無","肌","無","茶","茶","茶","無",
    "肌","茶","茶","茶","茶","茶","茶","茶","茶","無","茶","無","無","無","無","茶",
    "肌","茶","茶","茶","茶","茶","茶","茶","茶","無","肌","肌","肌","肌","肌","無",
    "肌","茶","茶","茶","茶","茶","茶","茶","茶","無","肌","茶","茶","茶","茶","無",
    "肌","茶","茶","茶","茶","茶","茶","茶","茶","無","肌","茶","茶","茶","茶","無",
    "肌","茶","茶","茶","茶","茶","茶","茶","茶","無","肌","茶","茶","茶","茶","無",
    "無","無","茶","茶","茶","茶","茶","茶","無","肌","茶","茶","茶","茶","茶","無",
    "肌","肌","無","無","茶","茶","茶","茶","無","肌","茶","茶","茶","茶","茶","無",
    "肌","茶","肌","肌","無","無","無","無","肌","茶","茶","茶","茶","茶","茶","無",
    "肌","茶","茶","茶","肌","肌","肌","無","肌","茶","茶","茶","茶","茶","茶","無",
    "肌","茶","茶","茶","茶","茶","茶","無","肌","茶","茶","茶","茶","茶","無","無",
    "茶","無","無","無","無","無","無","茶","肌","無","無","無","無","無","無","茶"
];
...
function getRgbCustomColor( c, baseColor )
{
    var colorHash = {
        "無":"#000000",
        "白":"#ffffff",
...
function getSingleLightCustomColor( c, baseColor, rgbType )
{
    var result = "";

    var rgb = getRgbCustomColor( c, baseColor );
    rgb = rgb.replace("#", "");
    var r = parseInt( "0x" + rgb.substr( 0, 2 ), 16 );
    var g = parseInt( "0x" + rgb.substr( 2, 2 ), 16 );
    var b = parseInt( "0x" + rgb.substr( 4, 2 ), 16 );
...
var blockImage = [];
var blockTexture = [];
function initBlock( baseColor ) {
    var rwidth = 16;
    var rheight = 16;
    var rsize = rwidth * rheight;
    //var tcolor = new THREE.Color( 0xffffff );
    var dataColor = new Uint8Array( rsize * 3 );
    for ( var i = 0; i < rsize; i ++ ) {
        //var h = i / 255;
        //tcolor.setHSV( 0.45 + 0.5 * h, 0.5 + 0.4 * h, h * h );
        dataColor[ i * 3 ]     = getSingleLightCustomColor( dataSet2[i], baseColor, "r" );
        dataColor[ i * 3 + 1 ] = getSingleLightCustomColor( dataSet2[i], baseColor, "g" );
        dataColor[ i * 3 + 2 ] = getSingleLightCustomColor( dataSet2[i], baseColor, "b" );
    }

    var texture = new THREE.DataTexture( dataColor, rwidth, rheight, THREE.RGBFormat );
    texture.needsUpdate = true;
    blockTexture[baseColor] = texture;
}
...
/*
                ...
                var alpha = 0.8; // 1.0;
*/
                var material = new THREE.MeshBasicMaterial( { map: blockTexture[dataSet[y*16+(15-x)]] } );
