...
ctx.beginPath();ctx.arc(170, 210, 10, 0, 2 * Math.PI, true);ctx.fill();
ctx.beginPath();ctx.arc(300, 210, 10, 0, 2 * Math.PI, true);ctx.fill();

// 口（外枠）
ctx.fillStyle = "#591B04";
ctx.beginPath();ctx.arc(215, 250, 28, 0, 2 * Math.PI, true);ctx.fill();
ctx.beginPath();ctx.arc(255, 250, 28, 0, 2 * Math.PI, true);ctx.fill();
// 口（塗りつぶし）
ctx.fillStyle = "#fee100";
ctx.beginPath();ctx.arc(215, 250, 22, 0, 2 * Math.PI, true);ctx.fill();
ctx.beginPath();ctx.arc(255, 250, 22, 0, 2 * Math.PI, true);ctx.fill();

// 鼻（外枠）
ctx.fillStyle = "#591B04";
ctx.beginPath();ctx.arc(235, 230, 18, 0, 2 * Math.PI, true);ctx.fill();
// 鼻（塗りつぶし）
ctx.fillStyle = "#D9041A";
ctx.beginPath();ctx.arc(235, 230, 13, 0, 2 * Math.PI, true);ctx.fill();
