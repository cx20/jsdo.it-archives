...
function init() {
    ...
    for ( var i = 0; i < 10; i++ ) {
        ...
        object.position.set(i * 50 -150, - i * 50 + 280, 0);
    ...
    var groundTexture = THREE.ImageUtils.loadTexture("../../assets/u/y/G/y/uyGy9.jpg", undefined, function () {
    ...
    // poles
    var poleGeo = new THREE.BoxGeometry(1, 800, 1);
...
function animate() {
    ...
    windStrength = Math.cos(time / 7000) * 100 + 100;
