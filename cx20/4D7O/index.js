...
function initTerrain(w, h) {
    ...
    terrain = new THREE.Mesh(
    	...
    	new THREE.MeshPhongMaterial ({
            ...
            map: THREE.ImageUtils.loadTexture('../../assets/o/c/R/i/ocRi9.png') // 黒部渓谷
		}));
...
function populate(n) {
    ...
    var max = 999; // document.getElementById("MaxNumber").value;
...
xhr.open('GET', '../../assets/7/D/o/H/7DoHj.csv', true); // 黒部渓谷
