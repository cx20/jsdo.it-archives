...
let camera = glBoostContext.createPerspectiveCamera({
    eye: new GLBoost.Vector3(2.0, 2.0, 3.0),
...
let url = "https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@c51a03cbff72037e33aa2cc0b7fe7cac4e4bdea8/models/gltf/2.0/EmaSimpleSkin/glTF/EmaSimpleSkin.gltf"; // COLLADA2GLTF 変換結果
//let url = "https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@76dfc928/models/gltf/2.0/EmaSimpleSkin_blender/glTF/EmaSimpleSkin_blender.gltf"; // Blender出力結果
