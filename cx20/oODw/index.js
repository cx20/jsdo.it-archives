...
for ( var i = 0; i < 1000; i++ ) {
    ...
    if ( vertex.length() < 10 ) {
        ...
        particlesPosition.push(new GLBoost.Vector3(x*0.5, y*0.5 + 10, z*0.5));
        particlesVelocity.push(new GLBoost.Vector3((Math.random() - 0.5) * 4/1000, Math.random() * 10/1000, (Math.random() - 0.5) * 4/1000));
    }
}
