// forked from cx20's "[WebGL] lightgl.js + ポリゴンで波動方程式を表示してみるテスト" http://jsdo.it/cx20/wmuM
// forked from cx20's "[WebGL] lightgl.js で波動方程式をプロットしてみるテスト" http://jsdo.it/cx20/5VBl
...
gl.ondraw = function() {
    ...
    for (i = 0; i <= N; i++) {
        for (j = 0; j <= N; j++) {
            ...
            mesh.colors.push([x + 0.5, y + 0.5, z + 0.5, 1.0]);
            a++;
        }
    }
