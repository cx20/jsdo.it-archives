// forked from cx20's "Glitchy Rainbow Mario（その２）" http://jsdo.it/cx20/30vg
// forked from cx20's "Glitchy Rainbow Mario（その１） " http://jsdo.it/cx20/vZug
...
function drawDot( x, y, colorR, colorG, colorB ) {
    drawArc( x+7*0, y, 3, colorR );
    drawArc( x+7*1, y, 3, colorG );
    drawArc( x+7*2, y, 3, colorB );

    drawArc( -2+x+7*0, y+5, 3, colorG );
    drawArc( -2+x+7*1, y+5, 3, colorB );
    drawArc( -2+x+7*2, y+5, 3, colorR );

    drawArc( x+7*0, y+10, 3, colorR );
    drawArc( x+7*1, y+10, 3, colorG );
    drawArc( x+7*2, y+10, 3, colorB );

    drawArc( -2+x+7*0, y+15, 3, colorG );
    drawArc( -2+x+7*1, y+15, 3, colorB );
    drawArc( -2+x+7*2, y+15, 3, colorR );
}
