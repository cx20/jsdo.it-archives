// forked from cx20's "[WebGL] shree.js を試してみるテスト（その３）（調整中）" http://jsdo.it/cx20/UuKj
// forked from cx20's "[WebGL] shree.js を試してみるテスト（その２）" http://jsdo.it/cx20/iJUS
// forked from cx20's "[WebGL] shree.js を試してみるテスト" http://jsdo.it/cx20/y7gw
