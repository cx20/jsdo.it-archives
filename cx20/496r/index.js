    ...
    */
    for (var i = 0; i < dataSet.length; i++) {
        if (dataSet[i] != "無") {
            ...
            var box = new b2PolygonShape();
            var pgd = new b2ParticleGroupDef();
            box.vertices[0] = new b2Vec2(-1.5 + x * 0.15, +3.0 + y * 0.15);
            box.vertices[1] = new b2Vec2(-1.5 + x * 0.15 + 0.1, +3.0 + y * 0.15);
            box.vertices[2] = new b2Vec2(-1.5 + x * 0.15 + 0.1, +3.0 + y * 0.15 + 0.1);
            box.vertices[3] = new b2Vec2(-1.5 + x * 0.15, +3.0 + y * 0.15 + 0.1);
            pgd.flags = b2_tensileParticle | b2_colorMixingParticle;
            pgd.shape = box;
