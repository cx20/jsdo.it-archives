Three.js で某スイーツを作ってみるテスト（その２）

＜対応した点＞
・SimplexNoise クラスを使用し表面をランダムに設定

＜参考＞
■ ファミリーマートの新作スイーツ「切れてるパンケーキ」がしいたけにしか見えないと話題に
http://nlab.itmedia.co.jp/nl/articles/1511/12/news091.html

■ three.js で富士山を描くテスト
http://jsdo.it/cx20/23oz

■ perlin-noise-simplex.js
https://gist.github.com/banksean/304522#file-perlin-noise-simplex-js

■ three_js の PlaneGeometry で地形を作る
http://yomotsu.net/blog/2012/12/01/create-terrain-with-threejs.html

■ Constructive Solid Geometry
http://ja.wikipedia.org/wiki/Constructive_Solid_Geometry

■ chandlerprall/ThreeCSG
https://github.com/chandlerprall/ThreeCSG

■ Constructive Solid Geometry (Three.js)
