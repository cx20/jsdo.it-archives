...
var createScene = function(engine) {
    ...
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@94bb7090/models/gltf/2.0/GrimoireLogo/glTF/", "GrimoireLogo.gltf", engine, function (newScene) {
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@94bb7090/models/gltf/2.0/GrimoireLogo/glTF_merge/", "GrimoireLogo.gltf", engine, function (newScene) {
    BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@94bb7090/models/gltf/2.0/VoxelCorgi/glTF_merge/", "VoxelCorgi.gltf", engine, function (newScene) {
        ...
        var light1 = new BABYLON.DirectionalLight("dir01", new BABYLON.Vector3(1, 1, 1), scene);
        var light2 = new BABYLON.DirectionalLight("dir02", new BABYLON.Vector3(-1, -1, -1), scene);
