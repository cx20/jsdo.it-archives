// forked from cx20's "[WebGL] Ashes で glTF 2.0形式のデータを表示してみるテスト（その２１）（調整中）" http://jsdo.it/cx20/kiUf
...
//let gltf = 'https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@c51a03cbff72037e33aa2cc0b7fe7cac4e4bdea8/models/gltf/2.0/EmaSimpleSkin/glTF/EmaSimpleSkin.gltf'; // COLLADA2GLTF 変換結果
//let gltf = 'https://cdn.jsdelivr.net/gh/cx20/gltf-test@9fb5f39992bdd548e17fb18b256c41b14fb8840e/sampleModels/CesiumMilkTruck/glTF/CesiumMilkTruck.gltf';
//let gltf = 'https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@94bb7090/models/gltf/2.0/VoxelCorgi/glTF_merge/VoxelCorgi.gltf';
//let gltf = 'https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Models@c89c1709fbfd67a11aa7e540ab4ecb795763b627/2.0/MetalRoughSpheres/glTF/MetalRoughSpheres.gltf';
...
//let gltf = 'https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Blender-Exporter@0e23c773bf27dad67d2c25f060370d6fa012d87d/polly/project_polly.gltf';
//let gltf = 'https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@8a3e977a/models/gltf/2.0/BearOnBalloons/scene.gltf';
//let gltf = 'https://cdn.jsdelivr.net/gh/mrdoob/rome-gltf@784089b4/files/models/life_soup/quadruped_fox.gltf';
//let gltf = 'https://cdn.jsdelivr.net/gh/pissang/claygl@c4f45119/example/assets/models/SambaDancing/SambaDancing.gltf';
//let gltf = 'https://cdn.jsdelivr.net/gh/cx20/gltf-test@e63efa65/tutorialModels/FlightHelmet/glTF/FlightHelmet.gltf';
//let gltf = 'https://cdn.jsdelivr.net/gh/ft-lab/ft-lab.github.io@c56ef016/gltf/grass/rocks_trees_ao.glb';
//let gltf = 'https://cdn.jsdelivr.net/gh/mrdoob/three.js@dev/examples/models/gltf/PrimaryIonDrive.glb';
//let gltf = 'https://cdn.jsdelivr.net/gh/mrdoob/three.js@dev/examples/models/gltf/LittlestTokyo.glb';
...
//let gltf = 'https://cdn.jsdelivr.net/gh/bghgary/glTF-Asset-Generator@a66119b3/Output/Material/Material_07.gltf';
//let gltf = 'https://cdn.jsdelivr.net/gh/mrdoob/three.js@r97/examples/models/gltf/BotSkinned/glTF-MaterialsUnlit/Bot_Skinned.gltf';
//let gltf = 'https://cdn.jsdelivr.net/gh/cx20/gltf-test@7af4f399/tutorialModels/SpecGlossVsMetalRough/glTF/SpecGlossVsMetalRough.gltf';
//let gltf = 'https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@33ab7250/models/gltf/2.0/Itokawa/glTF-Draco/Itokawa.glb';
//let gltf = 'https://cdn.jsdelivr.net/gh/BabylonJS/Exporters@9bc140006be149687be045f60b4a25cdb45ce4fc/Maya/Samples/glTF 2.0/T-Rex/trex_running.gltf';
let gltf = 'https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@ef789b017e86ed960bd38df4617fadbbfbd245ec/models/gltf/2.0/Kaendoki/glTF-Binary/Kaendoki.glb';
...
async function main() {
    ...
    vec3.set(entity1.components.Transform.translate, 0.0, -2.0, 0);
