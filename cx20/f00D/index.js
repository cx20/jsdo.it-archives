// forked from cx20's "御嶽山の3Dデータを表示してみた（その５）" http://jsdo.it/cx20/8QHC
...
Examples =
{
	smoke :
	{
		...
		positionBase     : new THREE.Vector3( -25, 35, 0 ), // 噴火口位置
...
*/
    ...
    for (var i = 0; i < y2; i++) {
        ...
        for (var j in r) {
            ...
            geometry.vertices[c].z = h * 1.0; //高さの強調度を変える場合は、ここの数値を変更する
            c++;
        }
    }
    var material = new THREE.MeshPhongMaterial({
        //map: THREE.ImageUtils.loadTexture('texture.png')
        map: THREE.ImageUtils.loadTexture('../../assets/u/I/H/z/uIHzv.png') // 御嶽山
    });
...
xhr.open('GET', '../../assets/j/r/9/M/jr9Mc.csv', true); // 御嶽山（256x256）
