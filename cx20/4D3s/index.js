...
var createScene = function(engine) {
    ...
    // box.gltf
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/cx20/gltf-test@9fb5f39992bdd548e17fb18b256c41b14fb8840e/sampleModels/CesiumMilkTruck/glTF/", "CesiumMilkTruck.gltf", engine, function (newScene) {
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@762acc8f/models/gltf/2.0/GrimoireLogo/glTF/", "GrimoireLogo.gltf", engine, function (newScene) {
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Models@c89c1709fbfd67a11aa7e540ab4ecb795763b627/2.0/MetalRoughSpheres/glTF/", "MetalRoughSpheres.gltf", engine, function (newScene) {
    ...
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Blender-Exporter@2bdcb263/polly/", "project_polly.gltf", engine, function (newScene) {
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Blender-Exporter@0e23c773bf27dad67d2c25f060370d6fa012d87d/polly/", "project_polly.gltf", engine, function (newScene) {
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@8a3e977a/models/gltf/2.0/BearOnBalloons/", "scene.gltf", engine, function (newScene) {
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/mrdoob/rome-gltf@784089b4/files/models/life_soup/", "quadruped_fox.gltf", engine, function (newScene) {
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/pissang/claygl@c4f45119/example/assets/models/SambaDancing/", "SambaDancing.gltf", engine, function (newScene) {
    BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/cx20/gltf-test@e63efa65/tutorialModels/FlightHelmet/glTF/", "FlightHelmet.gltf", engine, function (newScene) {
