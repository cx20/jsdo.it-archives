[WebGL] three.js で３次元リサージュ図形を描いてみるテスト（組み込み関数編）

＜対応した点＞
・THREE.Geometry / THREE.Line / THREE.LineBasicMaterial を用いて３次元リサージュ図形を描くよう対応
　設定例）
　x = sin(ω1t + α)
　y = sin(ω2t + β)
　z = sin(ω3t + γ)
...
http://jsdo.it/cx20/qLuh
■ [WebGL] three.js で３次元リサージュ図形を描いてみるテスト（組み込み関数編）
http://jsdo.it/cx20/iXHw
