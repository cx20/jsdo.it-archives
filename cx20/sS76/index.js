// forked from cx20's "[WebGL] RedGL で glTF 2.0形式のデータを表示してみるテスト（その２２）（調整中）" http://jsdo.it/cx20/4MRs
// forked from cx20's "[WebGL] RedGL で glTF 2.0形式のデータを表示してみるテスト（その２１）（調整中）" http://jsdo.it/cx20/kppQ
// forked from cx20's "[WebGL] RedGL で glTF 2.0形式のデータを表示してみるテスト（その２０）（調整中）" http://jsdo.it/cx20/ywUI
// forked from cx20's "[WebGL] RedGL で glTF 2.0形式のデータを表示してみるテスト（その１９）（調整中）" http://jsdo.it/cx20/4VO8
// forked from cx20's "[WebGL] RedGL で glTF 2.0形式のデータを表示してみるテスト（その１８）（調整中）" http://jsdo.it/cx20/sjHp
// forked from cx20's "[WebGL] RedGL で glTF 2.0形式のデータを表示してみるテスト（その１７）（調整中）" http://jsdo.it/cx20/o05i
// forked from cx20's "[WebGL] RedGL で glTF 2.0形式のデータを表示してみるテスト（その１６）（調整中）" http://jsdo.it/cx20/KK3Y
...
//var url = "https://cdn.jsdelivr.net/gh/cx20/gltf-test@a9cda755ff1c6656c5b3797b8747153e9e630947/tutorialModels/TextureSettingsTest/glTF/TextureSettingsTest.gltf";
...
//var url = "https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Models@c89c1709fbfd67a11aa7e540ab4ecb795763b627/2.0/MetalRoughSpheres/glTF/MetalRoughSpheres.gltf";
...
//var url = "https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Blender-Exporter@0e23c773bf27dad67d2c25f060370d6fa012d87d/polly/project_polly.gltf";
//var url = "https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@8a3e977a/models/gltf/2.0/BearOnBalloons/scene.gltf";
//var url = "https://cdn.jsdelivr.net/gh/mrdoob/rome-gltf@784089b4/files/models/life_soup/quadruped_fox.gltf";
//var url = "https://cdn.jsdelivr.net/gh/pissang/claygl@c4f45119/example/assets/models/SambaDancing/SambaDancing.gltf";
//var url = "https://cdn.jsdelivr.net/gh/cx20/gltf-test@e63efa65/tutorialModels/FlightHelmet/glTF/FlightHelmet.gltf";
