...
function init() {
    ...
    var back = new THREE.Mesh( buffgeoBack, new THREE.MeshBasicMaterial( { map:gradTexture([[1, 1, 1, 1], ['#FADBE0','#FADBE0','#FADBE0', '#FADBE0']]), side:THREE.BackSide, depthWrite: false }  ));
    ...
    var materialsBlack = [
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/8/i/P/5/8iP5k.png')}), // sumire.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/8/i/P/5/8iP5k.png')}), // sumire.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/4/1/k/G/41kGQ.png')}), // sumire_fd_front.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/g/x/A/Z/gxAZc.png')}), // sumire_fd_back.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/8/i/P/5/8iP5k.png')}), // sumire.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/8/i/P/5/8iP5k.png')})  // sumire.png
    ];

    var materialsYellow = [
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/k/l/k/h/klkhW.png')}), // ume.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/k/l/k/h/klkhW.png')}), // ume.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/w/1/Z/j/w1Zjf.png')}), // ume_fd_front.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/8/E/Z/D/8EZDv.png')}),  // ume_fd_back.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/k/l/k/h/klkhW.png')}), // ume.png
       new THREE.MeshLambertMaterial({map: THREE.ImageUtils.loadTexture('../../assets/k/l/k/h/klkhW.png')}), // ume.png
    ];
