...
*/
    matPocky[0] = new THREE.MeshLambertMaterial( {  map: image1, name:'pky1' } );
    matPocky[1] = new THREE.MeshLambertMaterial( {  map: image2, name:'pky2' } );
    matPocky[2] = new THREE.MeshLambertMaterial( {  map: image3, name:'pky3' } );
