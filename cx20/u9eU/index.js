            ...
            for ( var y = 0; y < voxelData.size.y; y++ ) {
                for ( var x = 0; x < voxelData.size.x; x++ ) {
                    ...
                    if ( voxel !== undefined ) {
                        ...
                        meshArray[i].position.x = 0;
                        meshArray[i].position.y = voxel.z * DOT_SIZE + Y_START_POS + 200;
...
// Animation
function transformTypeAnimation() {
