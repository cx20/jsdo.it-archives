...
var createScene = function(engine) {
    ...
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/ft-lab/ft-lab.github.io@c56ef016/gltf/grass/", "rocks_trees_ao.glb", engine, function (newScene) {
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/mrdoob/three.js@dev/examples/models/gltf/", "PrimaryIonDrive.glb", engine, function (newScene) {
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/mrdoob/three.js@dev/examples/models/gltf/", "LittlestTokyo.glb", engine, function (newScene) {
    //BABYLON.SceneLoader.Load("https://ft-lab.github.io/gltf/yunomi/", "Yunomi_normal_20.glb", engine, function (newScene) {
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/bghgary/glTF-Asset-Generator@a66119b3/Output/Material/", "Material_01.gltf", engine, function (newScene) {
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/bghgary/glTF-Asset-Generator@a66119b3/Output/Material/", "Material_04.gltf", engine, function (newScene) {
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/bghgary/glTF-Asset-Generator@a66119b3/Output/Material/", "Material_07.gltf", engine, function (newScene) {
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/mrdoob/three.js@r97/examples/models/gltf/BotSkinned/glTF-MaterialsUnlit/", "Bot_Skinned.gltf", engine, function (newScene) {
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/cx20/gltf-test@7af4f399/tutorialModels/SpecGlossVsMetalRough/glTF/", "SpecGlossVsMetalRough.gltf", engine, function (newScene) {
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@33ab7250/models/gltf/2.0/Itokawa/glTF-Draco/", "Itokawa.glb", engine, function (newScene) {
    //BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/BabylonJS/Exporters@9bc140006be149687be045f60b4a25cdb45ce4fc/Maya/Samples/glTF 2.0/T-Rex/", "trex_running.gltf", engine, function (newScene) {
    BABYLON.SceneLoader.Load("https://cdn.jsdelivr.net/gh/cx20/jsdo-static-contents@ef789b017e86ed960bd38df4617fadbbfbd245ec/models/gltf/2.0/Kaendoki/glTF-Binary/", "Kaendoki.glb", engine, function (newScene) {
