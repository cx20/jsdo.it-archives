// forked from cx20's "[WebGL] Grimoire.js + forward-shading でマテリアルをいろいろ試してみるテスト（その２）（調整中）" http://jsdo.it/cx20/iQ8t
// forked from cx20's "[WebGL] Grimoire.js + forward-shading でマテリアルをいろいろ試してみるテスト（調整中）" http://jsdo.it/cx20/kSof
...
gr.registerComponent('Rotate', {
  ...
  $mount: function () {
    ...
    img.src = "http://jsrun.it/assets/6/c/3/X/6c3XK.png"; // heightmap_256x256.png
  },
  $update: function () {
