// forked from cx20's "[WebGL] Grimoire.js カメラを回転させてみるテスト" http://jsdo.it/cx20/cikn
// forked from cx20's "[WebGL] Grimoire.js で Oimo.js を試してみるテスト（その２改2）" http://jsdo.it/cx20/Wl90
...
gr.register(() => {
    ...
    gr.registerComponent("Rigid", {
        ...
        $mount: function() {
            ...
            this.body.linearVelocity = new OIMO.Vec3((Math.random() - 0.5) * 10, 12, (Math.random() - 0.5) * 10);
        },
        $update: function() {
