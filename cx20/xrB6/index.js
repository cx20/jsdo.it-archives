// forked from cx20's "こいのぼりを放流させて見るテスト" http://jsdo.it/cx20/lu1b
// forked from cx20's "ドット絵が泳いでるっぽく見えるよう調整してみるテスト" http://jsdo.it/cx20/xFNB
...
function handleComplete() {
    ...
    for (i = 0; i < n; i++) {
        //setInstance(fishImg);
        setInstance(fishImg[Math.floor(Math.random()*3)]);
    }
