// forked from cx20's "[WebVR] A-Frame で WebVR を試してみるテスト（その９）（調整中）" http://jsdo.it/cx20/SxLP
// forked from cx20's "[WebVR] A-Frame で WebVR を試してみるテスト（その８）（調整中）" http://jsdo.it/cx20/SDFt
// forked from cx20's "[WebVR] A-Frame で WebVR を試してみるテスト（その７）（調整中）" http://jsdo.it/cx20/Qb57
// forked from cx20's "[WebVR] A-Frame で WebVR を試してみるテスト（その６）（調整中）" http://jsdo.it/cx20/8tid
// forked from cx20's "[WebVR] A-Frame で WebVR を試してみるテスト（その５）（調整中）" http://jsdo.it/cx20/syCY
// forked from cx20's "[WebVR] A-Frame で WebVR を試してみるテスト（その４）（調整中）" http://jsdo.it/cx20/qh52
