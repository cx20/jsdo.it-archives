...
function createMesh() {
    ...
    var coin_sides_texture           = THREE.ImageUtils.loadTexture("../../assets/u/p/U/j/upUji.png"); // side.png
    var coin_sides_texture_bump      = THREE.ImageUtils.loadTexture("../../assets/o/r/u/O/oruOi.png"); // side_bump.png
    var coin_cap_texture_top         = THREE.ImageUtils.loadTexture("../../assets/w/v/s/g/wvsgY.png"); // top.png
    var coin_cap_texture_top_bump    = THREE.ImageUtils.loadTexture("../../assets/s/Z/S/B/sZSB9.png"); // top_bump.png
    var coin_cap_texture_bottom      = THREE.ImageUtils.loadTexture("../../assets/k/u/M/M/KUMMj.png"); // bottom.png
    var coin_cap_texture_bottom_bump = THREE.ImageUtils.loadTexture("../../assets/4/f/n/t/4fnt6.png"); // bottom_bump.png
