...
var MAP = "../../assets/9/j/P/d/9jPdx.jpg"; // 空撮写真
var SMOKE = false;
var ROTATE = true;
...
Examples =
{
	smoke :
	{
		...
		positionBase     : new THREE.Vector3( 20, 18, 0 ), // 噴火口位置
		...
		accelerationBase : new THREE.Vector3( 20, 0, 20 ), // 煙の勢い
...
img.onload = function() {
    ...
    var mapSelector = gui.add(window, 'MAP', {
        "通常地図": "../../assets/o/Q/V/h/oQVh1.jpg",
        "空撮写真": "../../assets/9/j/P/d/9jPdx.jpg",
        "防災地図": "../../assets/w/8/b/F/w8bFJ.jpg",
        "火山地質図": "../../assets/6/C/X/g/6CXgs.jpg",
...
img.src = "../../assets/6/s/D/U/6sDUy.png"; // heightMap.png
